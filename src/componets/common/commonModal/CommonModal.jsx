    ...
    <>
      ...
      <Dialog.Root open={currentModal}>
        <Dialog.Portal>
          ...
          <Dialog.Content className="data-[state=open]:animate-contentShow fixed top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] bg-white shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] focus:outline-none border-2 border-black w-[90%] sm:w-[388px] rounded-[20px] p-5 sm:p-[55px] z-10">
            {renderCurrentModal()}
            <Dialog.Close>
              <button
                onClick={() => setCurrentModal(null)}
