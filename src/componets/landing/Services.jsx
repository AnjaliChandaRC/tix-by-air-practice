...
const Services = () => {
  return (
    <div className='relative'>
      ...
      <div className='container mx-auto px-6 max-w-[1188px] py-14 lg:pt-32 lg:pb-28 static z-10'>
      <div className='flex sm:items-center flex-col lg:flex-row justify-between mb-7 md:mb-12'>
        <h2 className='ff_satoshi_black text-[28px] sm:text-[38px] lg:text-5xl leading-[100%] text-black max-w-[531px] text-start sm:text-center lg:text-start mb-[10px]'>Discover Our Service Spectrum</h2>
      ...
      <div className='flex flex-row flex-wrap justify-center gap-[34px]'>
        {CardNameList.map((data, index) => {
          ...
          return (
            <div key={index} className={`border-2 border-black ${bgColorClass} hover:shadow-none transition-all duration-200 ease-linear shadow-[10px_10px_0px_0px] p-6  rounded-[10px] max-w-[354px] w-full min-h-[305px] `}>
              ...
              <h2 className='text-black text-xl md:text-2xl .ff_satoshi_medium leading-[120%] font-medium mt-6 mb-3'>{data.title}</h2>
              <h2 className='text-cedarbrown ff_inter leading-[150%]'>{data.description}</h2>
            </div>
          );
        })}
      </div>
