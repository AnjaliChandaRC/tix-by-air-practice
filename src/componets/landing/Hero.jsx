      ...
      <div className='container mx-auto px-6 max-w-[1188px]'>
        <div className='flex items-center flex-col md:flex-row '>
          ...
          <div className='relative mt-12 sm:mt-14 md:mt-0 md:ms-6 lg:ms-10 z-[1]'>
            ...
            {/* Main hero image */}
            <Image src='/assets/images/png/hero-img.png' alt='hero-image' className='relative z-10 max-w-[296px] sm:max-w-[350px] lg:max-w-[400px] xl:max-w-none' width={504} height={471} />
            {/* Top left line image */}
            <Image className='w-[140px] xl:!w-[145px] absolute -top-[5%] left-[-26px] sm:-left-[11px] lg:-top-[4%] lg:left-2 xl:left-10 xl:-top-[2%]' src='/assets/images/svg/single_line.svg' alt='hero-line' width={194} height={93} />
            {/* Bottom right line image */}
            <Image className='w-[140px] xl:!w-[145px] absolute bottom-[10%] -right-[37%] sm:-right-[33%] lg:-right-[27%] xl:-right-[20%] xl:bottom-[11%]' src='/assets/images/svg/single_line.svg' alt='hero-line' width={194} height={93} />
          </div>
        </div>
      </div>
    </div>
